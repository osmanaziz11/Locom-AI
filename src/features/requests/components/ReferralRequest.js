            ...
            return (
              <View style={styles.content}>
                ...
                <AppText
                  ...
                  Do you know this person? They would like to participate in
                ...
                <Button variant="warning" onPress={handlePressDeny}>
                  Deny
                </Button>
              </View>
            );
            ...
            return (
              <View style={{flex: 1}}>
                ...
                <View
                  ...
                  <AppText size={36} center style={{marginBottom: 8}}>
                    Are you sure?
                  </AppText>
                  <AppText color="#8083A3" weight={400} size={14} center>
                    Please, make sure you want to approve the user{' '}
                    {user.firstName} {user.lastName}
                  </AppText>
                  <Button
            ...
            return (
              <View style={{flex: 1}}>
                ...
                <View
                  ...
                  <AppText color="#8083A3" weight={400} size={14} center>
                    The user {user.firstName} {user.lastName} now has been
                    approved
                  </AppText>
                  <Button
                    style={{marginTop: 'auto'}}
