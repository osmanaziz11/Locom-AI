...
import { ButtonTabs, List, Tabs } from 'src/components/ui';
import { ReferralRequest, RequestCard } from '../components';
...
const RequestsScreen = () => {
  ...
  const renderRequest = ({item}) => {
    return <RequestCard {...item} onPress={handlePressRequest(item)} />;
  };
  ...
  return (
    <View style={[styles.container, {paddingTop: insets.top}]}>
      ...
      <View style={styles.content}>
        ...
        <List data={requests[currentTab]} renderItem={renderRequest} />
      </View>
      <BottomSheetModal
        ref={bottomSheetRef}
        index={0}
